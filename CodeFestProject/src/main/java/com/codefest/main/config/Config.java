...
import com.codefest.main.interceptors.RequestInterceptor;
...
public class Config extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(final ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/index.jsp").addResourceLocations(
	...
	public JdbcTemplate initializeDataSource() {
		...
		try {
			dataSource = (DataSource) jndi
					.lookup("java:comp/env/jdbc/postgresql/postgres");
